...
"""Verify that starting vanadium with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vanadium with -h for help text")
        ...
        self.log.info("Start vanadium with -version for version information")
