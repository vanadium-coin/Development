...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.vanadium.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.vanadiumtools.com");
        vSeeds.emplace_back("dnsseed.vanadiumpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.vanadiumtools.com");
        vSeeds.emplace_back("seed-b.vanadium.loshan.co.uk");
