...
const char * const BITCOIN_CONF_FILENAME = "vanadium.conf";
const char * const BITCOIN_PID_FILENAME = "vanadiumd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vanadium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vanadium";
#else
    // Unix
    return pathRet / ".vanadium";
#endif
#endif
}
