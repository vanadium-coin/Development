...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vanadium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vanadium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vanadium transaction") + "\n" +
              "  vanadium-tx [options] -create [commands]   " + _("Create hex-encoded vanadium transaction") + "\n" +
              "\n";
