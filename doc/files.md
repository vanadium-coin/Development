...
* vanadium.conf: contains configuration settings for vanadiumd or vanadium-qt
* vanadiumd.pid: stores the process id of vanadiumd while running
...
* debug.log: contains debug information and general logging generated by vanadiumd or vanadium-qt
